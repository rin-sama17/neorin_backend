...
class UpdateProductsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
      return [
            ...
            'ads_status'=>'required|max:120|min:2|regex:/^[ا-یa-zA-Z0-9\-۰-۹ء-ي., ]+$/u',
            ...
            'is_special'=>"required|numeric|in:0,1",
            'is_ladder'=>"required|numeric|in:0,1",
            'image'=>'nullable|max:3000|image|mimes:png,jpg,jpeg,gif',
            'price'=>'nullable|numeric',
            'tags'=>'nullable',
            'lat'=>'nullable|numeric',
            'lng'=>'nullable|numeric',
            'willing_to_trade'=>'required|numeric|in:0,1',
        ];
    }
}
